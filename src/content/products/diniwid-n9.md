---
# ОПУБЛИКОВАНО 10.08.2026. Модель подтверждена владельцем 10.08.
# ТТХ/комплектация/фото — с карточки naviseade.ee, цена = naviseade
# (решение 10.08). Наличие: on-order до ответа владельца.
sku: DNW-N9
name:
  es: 'Navegador GPS Diniwid N9 9" para camión'
  en: 'Diniwid N9 9" truck GPS navigator'
  ru: 'GPS-навигатор Diniwid N9 9" для грузовиков'
tagline:
  es: 'Pantalla grande de 9" para la cabina, con mapas de camión 3D Navi Truck'
  en: 'Large 9" cab screen with 3D Navi Truck maps'
  ru: 'Большой экран 9" для кабины, грузовые карты 3D Navi Truck'
description:
...
specs:
  ...
  - label: { es: 'Resolución', en: 'Resolution', ru: 'Разрешение' }
    value: '1280 × 800'
    source: 'https://www.naviseade.ee/product/90-diniwid-n9/'
  - label: { es: 'Procesador', en: 'Processor', ru: 'Процессор' }
    value: 'MStar MSB2531 Cortex-A7, 800 MHz'
    source: 'https://www.naviseade.ee/product/90-diniwid-n9/'
  - label: { es: 'Memoria RAM', en: 'RAM', ru: 'Оперативная память' }
    value: '256 MB DDR3'
    source: 'https://www.naviseade.ee/product/90-diniwid-n9/'
  ...
  - label: { es: 'Ranura de tarjeta', en: 'Card slot', ru: 'Слот карты памяти' }
    value: 'microSD'
    source: 'https://www.naviseade.ee/product/90-diniwid-n9/'
  - label: { es: 'Sistema operativo', en: 'Operating system', ru: 'Операционная система' }
    value: 'Windows CE 6.0'
    source: 'https://www.naviseade.ee/product/90-diniwid-n9/'
  - label: { es: 'Batería', en: 'Battery', ru: 'Аккумулятор' }
    value: '1500 mAh'
    source: 'https://www.naviseade.ee/product/90-diniwid-n9/'
  - label: { es: 'Dimensiones', en: 'Dimensions', ru: 'Габариты' }
    value: '220 × 140 mm'
    source: 'https://www.naviseade.ee/product/90-diniwid-n9/'
  - label: { es: 'Peso', en: 'Weight', ru: 'Вес' }
    value: '360 g'
    source: 'https://www.naviseade.ee/product/90-diniwid-n9/'
  - label: { es: 'USB', en: 'USB', ru: 'USB' }
    value: 'USB 2.0'
    source: 'https://www.naviseade.ee/product/90-diniwid-n9/'
box:
...
<!-- Заметки для наполнения (не публикуются).
- ТТХ и комплектация — с карточки магазина владельца (снято 10.08.2026):
  https://www.naviseade.ee/product/90-diniwid-n9/ («9.0" Diniwid N9 Truck», €169.90).
  Габариты на карточке — «-220мм -140мм» (толщина не указана); прежние сниппеты
  дилеров давали 180×115×10 — карточка владельца приоритетнее, но при случае
  сверить с ediniwid.com.
- Плёнка/шайба/чехол — из описания карточки («Пленка на экране, шайба для
  крепления, чехол»); в списке «Комплектация» их нет — при сверке с владельцем
  подтвердить.
- Страница производителя: https://www.ediniwid.com/navigations/diniwid-n9/
- Карты: полный список 46 стран (вкл. Испанию 99%, выпуск 2026) — см.
  https://www.naviseade.ee/auxpage_navigation/ и черновик услуги map-update.
-->
